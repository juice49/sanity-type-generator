// https://github.com/sanity-io/sanity/blob/48eeac97606d9940d89a69b41c5cf230768b1a88/packages/sanity/src/_internal/cli/util/mockBrowserEnvironment.ts
...
export default function mockBrowserEnvironment(basePath: string): () => void {
